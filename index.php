...
<nav class="navbar navbar-expand-lg sticky-top shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-bold" href="#">🐶 My Pet Shop</a>
...
<!--                <li class="nav-item"><a class="nav-link" href="#">Products</a></li>-->
                <li class="nav-item"><a class="nav-link" href="cart.php">Cart <span class="badge bg-danger rounded-pill" id="cart-count">0</span></a></li>
            </ul>
        </div>
    </div>
</nav>
